    ...
    return (
        <div className='w-full'>
            ...
            <form className="max-w-md mx-auto">
                ...
                <button type="submit"
                        className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 bg-primaryColor focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Đăng ký ngay
                </button>
            </form>
