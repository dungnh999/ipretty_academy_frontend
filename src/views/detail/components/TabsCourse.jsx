            ...
            content: <div>
                        ...
                        <div className="list-lessons flex gap-[0.75rem] flex-col mt-[1.25rem]">
                            { dataCourse['listChapterLesson'].map((item, key) => (
                                <div key={item['id']} className='bg-whiteColor rounded-lg item-lessons'>
                                    <details className="group marker:content-['']" open={key != 0 ? '' : 'open'}>
                                        <summary
        ...
        },
        {
            ...
            content: <div className='flex flex-col gap-[1.25rem]'>
                        <div className='flex gap-[1.5rem] items-center'>
                            <div className='box-image w-[11.25rem] h-[11.25rem] bg-black rounded-2xl overflow-hidden'>
                                <ImageBannerWithFallback src={dataCourse['teacherInfo']['avatar']} className='h-full w-full object-contain'/>
                            </div>
